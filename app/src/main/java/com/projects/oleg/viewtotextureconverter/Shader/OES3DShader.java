...
public class OES3DShader extends Shader {
    ...
    private final String mVertexShader =
            "uniform mat4 uMVPMatrix;\n" +
                    ...
                    "  vTextureCoord = vec2(aTextureCoord.x / gl_Position.z, aTextureCoord.y / gl_Position.z);\n" +
    ...
    private final String mFragmentShader =
                    ...
                    "void main() {\n" +
                    "  vec2 reintTxt = vec2(vTextureCoord.x/vTextureCoordInv.x,vTextureCoord.y/vTextureCoordInv.x);"+
