...
public abstract class Shader {
    ...
    protected int loadShader(int shaderType, String source) {
        ...
        if (shader != 0) {
            ...
            if (compiled[0] == 0) {
                Utils.print("Could not compile shader " + shaderType + ":");
                Utils.print(GLES20.glGetShaderInfoLog(shader));
    ...
    protected int createProgram(String vertexSource, String fragmentSource) {
        ...
        if (program != 0) {
            ...
            if (linkStatus[0] != GLES20.GL_TRUE) {
                Utils.print("Could not link program: ");
                Utils.print(GLES20.glGetProgramInfoLog(program));
